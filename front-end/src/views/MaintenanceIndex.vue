<template>
  <div class="container">
    <div class="top">
      ...
      <div class="info">
        <el-popover
          placement="top"
          width="100"
          v-model="pageState.isInfoHintShow"
        >
          ...
          <div style="text-align: right; margin: 0">
            <el-button
              size="mini"
              type="text"
              @click="pageState.isInfoHintShow = false"
              >否</el-button
            >
          ...
          <div slot="reference" style="margin: auto">
            ...
            <span
              >【{{
                this.$store.state.currentUser == null
                  ? ""
                  : this.$store.state.currentUser.identity
              }}】</span
            >
          </div>
        </el-popover>
    ...
    <div class="center">
      <div
        class="aside"
        @mouseenter="pageState.isCollapse = false"
        @mouseleave="pageState.isCollapse = true"
      ...
      >
        ...
        >
          <el-menu-item
            ...
            @click="$router.replace('/MaintenanceIndex')"
          >
